...
DEVICE_SETS = {
    ...
    #CoCoDeviceClass.PIR: {INTERNAL_KEY_CLASS: CoCoPir, INTERNAL_KEY_MODELS: LIST_VALID_PIRS}
}
...
class CoCo:
    ...
    def _process_devices_list(self, response):
        ...
        #self.initialize_devices(CoCoDeviceClass.PIR, actionable_devices)
